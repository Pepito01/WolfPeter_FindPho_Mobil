...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (isLoggedIn){
                    startActivity(new Intent(MainActivity.this, com.example.findpho.HomeActivity.class));
                    finish();
                }
    ...
    private void isFirstTime() {
        ...
        if (isFirstTime){
            ...
            startActivity(new Intent(MainActivity.this, com.example.findpho.OnBoardActivity.class));
            finish();
        }
        else{
            //start Auth Activity
